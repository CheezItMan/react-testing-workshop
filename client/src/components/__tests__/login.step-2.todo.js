...
import {generate, cleanup, fireEvent} from 'til-client-test-utils'
...
test('calls onSubmit with the username and password when submitted', () => {
  ...
  const submitButtonNode = getByText(/[sS]ubmit/)
...
/*
http://ws.kcd.im/?ws=Testing&e=login.step-2%20(react-testing-library)&em=mcanallyc@gmail.com
*/
